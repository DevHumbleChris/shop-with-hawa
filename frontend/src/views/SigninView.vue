...
const handleSubmit = async () => {
    ...
    await signInWithEmailAndPassword(auth, formDetails.value.email, formDetails.value.password)
        .then(() => {
    ...
    <section>
        <div class="relative py-4 overflow-hidden bg-gray-100 sm:py-16 lg:py-20 xl:py-10">
            <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl grid sm:grid-cols-2 items-center gap-2">
                <img src="../assets/images/illustration-one.png" alt="illustration-one" class="px-6 py-12 lg:px-8">
                <div
                    class="flex flex-col justify-center px-3 py-12 shadow-xl rounded-2xl shadow-slate-300 whitespace-nowrap space-y-2 bg-white">
                    <div class="space-y-3">
                        ...
                        <h2 class="text-center text-xl sm:text-2xl font-bold leading-9 tracking-tight text-gray-900">Sign in
                            to
                            your account</h2>
                    </div>
                    ...
                    <div class="sm:mx-auto sm:w-full sm:max-w-sm">
                        <form class="space-y-6" @submit.prevent="handleSubmit">
                            <div>
                                <label for="email" class="block text-sm font-medium leading-6 text-gray-900">Email
                                    address</label>
                                <div class="mt-2">
                                    <input v-model="formDetails.email" id="email" name="email" type="email" required
                        ...
                        <p class="mt-5 text-center text-sm text-gray-500">
                            Not a member?
                            <RouterLink to="/signup" class="font-semibold leading-6 text-primary hover:text-indigo-600">
                                Create a new
                                account.</RouterLink>
                        </p>
